...
bool ProjectionDepthFactor::Evaluate(double const *const *parameters, double *residuals, double **jacobians) const
{
    ...
    if(jacobians){
        ...
        if(jacobians[0]){
            ...
            for(int i=0; i<6; i++)
                jacobian_pose_i(i) = sqrt_info * jaco_i(2, i);
            jacobian_pose_i(6) = 0; 
        }
        ...
        if(jacobians[1]){
            ...
            for(int i=0; i<6; i++)
                jacobian_pose_j(i) = sqrt_info * jaco_j(2, i);
            jacobian_pose_j(6) = 0; 
        }
        ...
        if(jacobians[2]){
            ...
            for(int i=0; i<6; i++)
                jacobian_ex_pose(i) = sqrt_info * jaco_ex(2, i);
        ...
        if(jacobians[3]){
            ...
            jacobians[3][0] = sqrt_info * jaco_lambda(2); 
        }
